    ...
    <section className='h-screen pt-28'>
      ...
      <div className='flex flex-row justify-between'>
        <div className='grid grid-cols-2 h-fit bg-white justify-self-center infor'>
          <div className='col-span-2 text-xl text-black py-6 px-8'>
            ...
            <p className='font-normal'>
              <span className='text-gray'>&#62; Based in </span>Ho Chi Minh city, Vietnam
            </p>
            <p className='font-normal'>
              <span className='text-gray'>&#62; Contact me: </span>
              <a href='mailto:fubbuj@gmail.com' className='link-to-mail'>
                fubbuj@gmail.com
              </a>
            </p>
          </div>
        ...
        <div>
          <Image
            src={Taptap}
            alt='Phuc Bui is tapping to contact with client'
            width={500}
            height={500}
          />
        </div>
