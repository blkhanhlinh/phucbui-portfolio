      ...
      <div className={classNames(styles.intro, "flex flex-col md:flex-row-reverse md:justify-between md:items-center gap-4 pt-16 md:pt-0")}>
        ...
        <div className="flex flex-col gap-8">
          <div className="flex flex-col gap-5">
            <h2 className="text-base md:text-lg text-dark-gray md:mb-6">
              Xin chào, I am
            </h2>
            <Image src={Name} alt="fubbuj" className={classNames(styles.name)}/>
            <h1 className="text-sm md:text-2xl text-light-gray text-right">
              a.k.a @fubbuj
            </h1>
          </div>
        <div className="flex self-end">
          <p className="text-xs md:text-base text-right text-dark-gray md:w-[530px]">I'm currently a <strong>senior graphic design student</strong> at Van Lang University, Vietnam.</p>
        </div>
        </div>
      </div>
    </section>
